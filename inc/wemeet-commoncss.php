...
// enqueue css
function wemeet_common_custom_css(){
    
    wp_enqueue_style( 'wemeet-common', get_template_directory_uri().'/assets/css/common.css' );
		...
		$headerTop_bg     		  = '';
		$navbarBgColor     		  = wemeet_opt( 'wemeet_navbar_bg_color' ) != '#082b49' ? wemeet_opt( 'wemeet_navbar_bg_color') : '';
		$headerTop_col     		  = wemeet_opt( 'wemeet_top_header_color' );

		$headerTopBg      		  = wemeet_opt( 'wemeet_top_header_bg_color');
		$headerBg          		  = wemeet_opt( 'wemeet_header_bg_color') != '#ffffff' ? wemeet_opt( 'wemeet_header_bg_color') : '';
		$menuColor          	  = wemeet_opt( 'wemeet_header_menu_color' ) != '#131313' ? wemeet_opt('wemeet_header_menu_color') : '';
		$menuHoverColor           = wemeet_opt( 'wemeet_header_menu_hover_color' ) != '#808080' ? wemeet_opt('wemeet_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = wemeet_opt( 'wemeet_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = wemeet_opt( 'wemeet_header_drop_menu_bg_color' ) != '#ffffff' ? wemeet_opt('wemeet_header_drop_menu_bg_color') : $themeColor;
		...
		$foftonecolor			  = wemeet_opt('wemeet_fof_textone_color');
		$fofttwocolor			  = wemeet_opt('wemeet_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = wemeet_opt('wemeet_footer_widget_anchor_color') != '#9e9e9e' ? wemeet_opt('wemeet_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .wemeet_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .wemeet_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'wemeet-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'wemeet_common_custom_css', 50 );