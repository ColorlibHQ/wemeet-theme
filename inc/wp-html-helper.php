...
// image default alt
if ( ! function_exists( 'wemeet_img_default_alt' ) ) {
	function wemeet_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'wemeet_img_tag' ) ) {
	function wemeet_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = wemeet_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'wemeet_anchor_tag' ) ) {
	function wemeet_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'wemeet_heading_tag' ) ) {
	function wemeet_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'wemeet_paragraph_tag' ) ) {
	function wemeet_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'wemeet_other_tag' ) ) {
	function wemeet_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'wemeet_button_element ' ) ) {
	function wemeet_button_element( array $args ) {
